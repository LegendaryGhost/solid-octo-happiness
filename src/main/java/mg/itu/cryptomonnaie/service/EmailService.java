...
public class EmailService {
    ...
    public void envoyerValidationHistoFondEmail(String recipientEmail, String token) throws MessagingException {
	...
	helper.setText(htmlContent, true); // Le deuxième paramètre "true" indique que le contenu est en HTML.
