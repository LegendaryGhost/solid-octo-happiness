...
public class TransactionController {
    ...
    @GetMapping("/filtre")
    public String filtreGlobal(
        Model model,
        @RequestParam(name = "dateMax", required = false) LocalDateTime localDateTime
    ) {
        model.addAttribute("historiqueTransaction", transactionService.getResumesHistoriquesTransactionGroupByUtilisateur());
