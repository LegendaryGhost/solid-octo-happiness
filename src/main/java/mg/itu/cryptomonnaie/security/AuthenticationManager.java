...
public class AuthenticationManager {
    ...
    public void authenticate(final String email) {
        Utils.getCurrentSession().setAttribute(AUTHENTICATED_USER_KEY, profilService.getByEmail(email));
    }

    @Nullable
    public Profil getCurrentUser() {
        return (Profil) Utils.getCurrentSession().getAttribute(AUTHENTICATED_USER_KEY);
    }
